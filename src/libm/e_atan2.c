...
static const double tiny = 1.0e-300, zero = 0.0, pi_o_4 = 7.8539816339744827900E-01, /* 0x3FE921FB, 0x54442D18 */
...
double attribute_hidden __ieee754_atan2(double y, double x) {
	...
	iy = hy & 0x7fffffff;
	if(((ix | ((lx | -(int32_t) lx) >> 31)) > 0x7ff00000) || ((iy | ((ly | -(int32_t) ly) >> 31)) > 0x7ff00000)) {    /* x or y is NaN */
		return x + y;
	}
