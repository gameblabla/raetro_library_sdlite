			...
			switch (*fmt++) {
				...
				case 'l':
					switch (*fmt++) {
						...
						case 'x':
						case 'X':
							error->args[error->argc++].value_l = va_arg(ap,
							long);
							break;
					}
					break;
				...
				case 'x':
				case 'X':
					error->args[error->argc++].value_i = va_arg(ap,
					int);
					break;
				case 'f':
					error->args[error->argc++].value_f = va_arg(ap,
					double);
					break;
				case 'p':
					error->args[error->argc++].value_ptr = va_arg(ap,
					void *);
					break;
				case 's': {
					int i = error->argc;
