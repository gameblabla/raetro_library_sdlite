...
enum { /* bitmap pixel order, high bit -> low bit */
	SDL_BitmapOrder_None,
	SDL_BitmapOrder_4321,
	SDL_BitmapOrder_1234,
};

enum { /* packed component order, high bit -> low bit */
...
enum { /* array component order, low byte -> high byte */
	SDL_ArrayOrder_None,
	SDL_ArrayOrder_RGB,
	SDL_ArrayOrder_RGBA,
	SDL_ArrayOrder_ARGB,
...
#define SDL_DEFINE_PIXELFORMAT(type, order, layout, bits, bytes) ((1 << 31) | ((type) << 24) | ((order) << 20) | ((layout) << 16) | ((bits) << 8) | ((bytes) << 0))
...
#define SDL_ISPIXELFORMAT_INDEXED(format) ((SDL_PIXELTYPE(format) == SDL_PixelType_Index1) || (SDL_PIXELTYPE(format) == SDL_PixelType_Index4) || (SDL_PIXELTYPE(format) == SDL_PixelType_Index8))

#define SDL_ISPIXELFORMAT_FOURCC(format) ((format) && !((format) & 0x80000000))

enum {
	SDL_PixelFormat_Unknown,
	SDL_PixelFormat_Index1LSB   = SDL_DEFINE_PIXELFORMAT(SDL_PixelType_Index1,   SDL_BitmapOrder_1234, 0, 1, 0),
	SDL_PixelFormat_Index1MSB   = SDL_DEFINE_PIXELFORMAT(SDL_PixelType_Index1,   SDL_BitmapOrder_4321, 0, 1, 0),
	SDL_PixelFormat_Index4LSB   = SDL_DEFINE_PIXELFORMAT(SDL_PixelType_Index4,   SDL_BitmapOrder_1234, 0, 2, 0),
	SDL_PixelFormat_Index4MSB   = SDL_DEFINE_PIXELFORMAT(SDL_PixelType_Index4,   SDL_BitmapOrder_4321, 0, 2, 0),
 ...
 */
extern DECLSPEC int SDLCALL SDL_AddPaletteWatch(SDL_Palette *palette, SDL_PaletteChangedFunc callback, void *userdata);
 ...
 */
extern DECLSPEC void SDLCALL SDL_DelPaletteWatch(SDL_Palette *palette, SDL_PaletteChangedFunc callback, void *userdata);
