...
/*!*****************************************************************************
 * @file SDL_audio.h
 * @brief Header for access to the raw audio mixing buffer.
 *
 ...
 ******************************************************************************/
/*!*****************************************************************************
 * @defgroup audio SDL_audio
 * @brief Audio Device Management, Playing and Recording
 * @details Contains functions for handling audio devices and audio input/output.
 * @{
 ******************************************************************************/
#ifndef SDL_audio_h_
#define SDL_audio_h_
...
/**
 * @brief Native audio byte ordering
 */
...
/**
 * @brief Set the name of the current audio driver.
 *
...
/**
 * @brief Compatibility convenience function -- loads a WAV from a file
 */
#define SDL_LoadWAV(file, spec, audio_buf, audio_len) \
    SDL_LoadWAV_RW(SDL_RWFromFile(file, "rb"),1, spec,audio_buf,audio_len)

/**
 * @brief This function frees data previously allocated with SDL_LoadWAV_RW().
 */
extern DECLSPEC void SDLCALL SDL_FreeWAV(Uint8 *audio_buf);

/**
 * @brief Initialize an SDL_AudioCVT structure for conversion.
 *
 ...
 * @param src_rate the frequency (samples-frames-per-second) of the source
 * @param dst_format the destination format of the audio data; for more info see SDL_AudioFormat
 * @param dst_channels the number of channels in the destination
 * @param dst_rate the frequency (samples-frames-per-second) of the destination
...
/**
 * @brief LockAudio/UnlockAudio pair
 */
